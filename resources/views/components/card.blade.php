<div class="col-12 col-lg-4 col-md-6 d-flex justify-content-center" data-aos="flip-up">
    <div class="card brand-alpha px-0 my-4 rounded-0" style="width: 15rem;">
        <div class="c-header">
            ...
            $announcement->images()->first()->getUrl(400,400) : 'https://picsum.photos/800/800'}}" class="img-fluid w-100" alt="foto-annuncio"> 
        ...
        <div class="card-body-text  brand-cool-bg ps-0">
            ...
            <a class="brand-grey" href="{{route('category.view', $announcement->category)}}">{{$announcement->category->name}}</a>
        </div>
