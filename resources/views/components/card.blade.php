<div class="col-12 col-md-6 col-lg-4 align-items-center justify-content-center">
    <div class="card px-0 mx-auto my-4" style="width: 18rem;">
        <div class="c-header">
            <img src="https://picsum.photos/300/300" class="img-fluid w-100" alt="foto-annuncio">
            <span class="btn c-category brand-white brand-dark-bg"><a href="{{route('category.view', $announcement->category)}}">{{$announcement->category->name}}</a></span>
